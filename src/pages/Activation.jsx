      ...
      <div className="w-full max-w-md rounded-lg border border-line bg-surface p-6 shadow-card">
        ...
        <div className="mb-5 rounded border border-line bg-paper p-3">
          ...
          <div className="flex items-center justify-between gap-2">
            <code className="tnum text-sm text-ink">{status?.machineId}</code>
            <button
              onClick={handleCopy}
              className="flex h-8 w-8 items-center justify-center rounded text-ink-mute hover:bg-surface hover:text-brand"
              title="نسخ"
            >
